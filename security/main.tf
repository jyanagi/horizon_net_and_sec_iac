...
resource "nsxt_policy_group" "cs_vip" {
  display_name = "TF-HZN-GRP-CS-VIP"
...
resource "nsxt_policy_group" "uag_vip" {
  display_name = "TF-HZN-GRP-UAG-VIP"
...
resource "nsxt_policy_group" "desktop_pool" {
  display_name = "TF-HZN-GRP-VDI-POOL"
...
resource "nsxt_policy_service" "service_hzn_HTTPS_8443" {
  ...
  display_name = "TF-HZN-SVC-HTTPS-8443"
...
resource "nsxt_policy_service" "service_hzn_blast" {
  ...
  display_name = "TF-HZN-SVC-BLAST"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-BLAST-TCP-443"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-BLAST-TCP-8443"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-BLAST-UDP-443"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-BLAST-UDP-8443"
...
resource "nsxt_policy_service" "service_hzn_pcoip" {
  ...
  display_name = "TF-HZN-SVC-PCOIP"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-PCOIP-UDP-4172"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-PCOIP-TCP-4172"
...
resource "nsxt_policy_service" "service_hzn_blast_22443" {
  ...
  display_name = "TF-HZN-SVC-BLAST-22443"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-BLAST-UDP-22443"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-BLAST-TCP-22443"
...
resource "nsxt_policy_service" "service_hzn_rdp" {
  ...
  display_name = "TF-HZN-SVC-RDP"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-RDP-3389"
...
resource "nsxt_policy_service" "service_hzn_cdr" {
  ...
  display_name = "TF-HZN-SVC-CDR"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-CDR-9427"
    description       = "Horizon Client Drive Redirection"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_usb" {
  ...
  display_name = "TF-HZN-SVC-USB"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-USB-32111"
    description       = "Horizon USB Drive Redirection"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_mssql" {
  ...
  display_name = "TF-HZN-SVC-MSSQL"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-MSSQL-1433"
    description       = "Horizon Connection Server - MSSQL"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_oracle" {
  ...
  display_name = "TF-HZN-SVC-ORACLE"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-ORACLE-1521"
    description       = "Horizon Connection Server - ORACLE"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_jms_legacy" {
  ...
  display_name = "TF-HZN-SVC-JMS-LEGACY"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-JMS-LEGACY-4001"
    description       = "Horizon Connection Server - JMS Legacy"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_jms_enhanced" {
  ...
  display_name = "TF-HZN-SVC-JMS-ENHANCED"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-JMS-ENHANCED-4002"
    description       = "Horizon Connection Server - JMS ENHANCED"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_jms_redundancy" {
  ...
  display_name = "TF-HZN-SVC-JMS-REDUNDANCY"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-JMS-REDUNDANCY-4100"
    description       = "Horizon Connection Server - JMS Redundancy"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_jms_ssl" {
  ...
  display_name = "TF-HZN-SVC-JMS-SSL"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-JMS-SSL-4101"
    description       = "Horizon Connection Server - JMS Redundancy SSL"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_soap" {
  ...
  display_name = "TF-HZN-SVC-SOAP"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-SOAP-443"
    description       = "Horizon Connection Server to vCenter Server SOAP"
    protocol          = "TCP"
    destination_ports = ["443"]
  }
...
resource "nsxt_policy_service" "service_hzn_replica" {
  ...
  display_name = "TF-HZN-SVC-REPLICA"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-32111"
    description       = "Horizon Connection Server Install Replica"
    protocol          = "TCP"
    destination_ports = ["32111"]
  }
...
resource "nsxt_policy_service" "service_hzn_replica_ldap" {
  ...
  display_name = "TF-HZN-SVC-LDAP"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-LDAP-TCP-389"
    description       = "Horizon Connection Server Install Replica LDAP"
    protocol          = "TCP"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-LDAP-TCP-636"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-LDAP-UDP-389"
    description       = "Horizon Connection Server Install Replica LDAP"
    protocol          = "UDP"
    destination_ports = ["389"]
  }
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-LDAP-UDP-636"
    description       = "Horizon Connection Server Install Replica SLDAP"
    protocol          = "UDP"
    destination_ports = ["636"]
  }
...
resource "nsxt_policy_service" "service_hzn_replica_ldap_gc" {
  ...
  display_name = "TF-HZN-SVC-LDAP-GC"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-LDAP-GC-TCP-3268"
    description       = "Horizon Connection Server Install Replica LDAP GC"
    protocol          = "TCP"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-REPLICA-SLDAP-GC-TCP-3269"
...
resource "nsxt_policy_service" "service_hzn_kerberos" {
  ...
  display_name = "TF-HZN-SVC-CS-KERBEROS"
...
resource "nsxt_policy_service" "service_hzn_netbios" {
  ...
  display_name = "TF-HZN-SVC-CS-NETBIOS"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-CS-NETBIOS-UDP"
    description       = "Horizon Connection Server to Domain NetBIOS"
    protocol          = "UDP"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-CS-NETBIOS-TCP"
    description       = "Horizon Connection Server to Domain NetBIOS"
    protocol          = "TCP"
    destination_ports = ["137-139"]
  }
...
resource "nsxt_policy_service" "service_hzn_dem" {
  ...
  display_name = "TF-HZN-SVC-DEM"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-DEM-TCP"
  ...
  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-DEM-UDP"
...
resource "nsxt_policy_service" "service_hzn_dem_flex" {
  ...
  display_name = "TF-HZN-SVC-DEM-FLEX"
...
resource "nsxt_policy_service" "service_hzn_alg_ms_rpc" {
  ...
  display_name = "TF-HZN-SVC-ALG-MS_RPC"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-ALG-MS_RPC-135"
    description       = "Horizon Connection Server to Connection Server MS_RPC"
    protocol          = "TCP"
...
resource "nsxt_policy_service" "service_hzn_alg_ms_rpc_dynamic" {
  ...
  display_name = "TF-HZN-SVC-ALG-MS_RPC-DYNAMIC"
...
resource "nsxt_policy_service" "service_hzn_uag_radius" {
  ...
  display_name = "TF-HZN-SVC-UAG-RADIUS"

  l4_port_set_entry {
    display_name      = "TF-HZN-SVC-UAG-RADIUS-5500"
    description       = "Horizon UAG - RADIUS"
    protocol          = "UDP"
...
resource "nsxt_policy_service" "service_hzn_app_volumes_agent" {
  ...
  display_name = "TF-HZN-SVC-APP-VOLUMES-AGENT"
...
resource "nsxt_policy_service" "service_hzn_cpa_vipa" {
  ...
  display_name = "TF-HZN-SVC-CPA-VIPA"
...
resource "nsxt_policy_context_profile" "cp_kerberos" {
  display_name = "TF-HZN-CP-KERBEROS"
...
resource "nsxt_policy_context_profile" "cp_ad" {
  display_name = "TF-HZN-CP-ACTIVE-DIRECTORY"
...
resource "nsxt_policy_security_policy" "allow_HZN" {
  display_name = "TF - Horizon Security Policies"
  description  = "Terraform Created Horizon Security Policies"
  ...
  rule {
    display_name       = "TF - Load Balancer to UAG HTTPS"
  ...
  rule {
    display_name       = "TF- Load Balancer to UAG PCoIP"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.uag_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Load Balancer to UAG BLAST"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.uag_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Load Balancer to Connection Server HTML Access"
    source_groups      = [nsxt_policy_group.lb_data.path]
  ...
  rule {
    display_name       = "TF - Load Balancer to Connection Server HTTPS"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_HTTPS.path]
  ...
  rule {
    display_name       = "TF - Load Balancer to Horizon Agent via BLAST Extreme"
    source_groups      = [nsxt_policy_group.lb_data.path]
  ...
  rule {
    display_name       = "TF - Load Balancer to Horizon Agent via PCoIP"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_pcoip.path]
  ...
  rule {
    display_name       = "TF - Load Balancer to Horizon Agent via RDP"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Load Balancer to Horizon Agent Client Device Redirection"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Load Balancer to Horizon Agent USB Redirection"
    source_groups      = [nsxt_policy_group.lb_data.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Internal - Horizon Client to Horizon Agent via PCoIP"
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_pcoip.path]
    #profiles           = [nsxt_policy_context_profile.cp_pcoip.path]
  ...
  rule {
    display_name       = "TF - Internal - Horizon Client to Horizon Agent via BLAST"
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_blast_22443.path]
    #profiles           = [nsxt_policy_context_profile.cp_blast.path]
  ...
  rule {
    display_name       = "TF - Internal - Horizon Client to Horizon Agent via RDP"
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_rdp.path]
    #profiles           = [nsxt_policy_context_profile.cp_rdp.path]
  ...
  rule {
    display_name       = "TF - Internal - Horizon Client to Horizon Agent Client Drive Redirection"
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_cdr.path]
    logged             = false
  ...
  rule {
    display_name       = "TF - Internal - Horizon Client to Horizon Agent USB Redirection"
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_usb.path]
    logged             = false
  ...
  rule {
    display_name       = "TF - Internal - Browser to Connection Server HTML Access"
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_HTTPS_8443.path]
    #profiles           = [nsxt_policy_context_profile.cp_https.path]
  ...
  rule {
    display_name       = "TF - Internal - Browser to Connection Server HTTP"
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Internal - Browser to Connection Server HTTPS"
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_HTTPS.path]
    #profiles           = [nsxt_policy_context_profile.cp_https.path]
  ...
  rule {
    display_name       = "TF - External - Horizon Clients to UAG HTTPS"
  ...
  rule {
    display_name       = "TF - External - Horizon Client to UAG PCoIP"
    destination_groups = [nsxt_policy_group.uag_vip.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_pcoip.path]
    #profiles           = [nsxt_policy_context_profile.cp_pcoip.path]
  ...
  rule {
    display_name       = "TF - UAG - Horizon Client to Horizon Portal"
  ...
  rule {
    display_name       = "TF - UAG - UAG to Horizon Agent via BLAST Extreme"
    source_groups      = [nsxt_policy_group.uag_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_blast_22443.path]
  ...
  rule {
    display_name       = "TF - UAG - UAG to Horizon Agent via PCoIP"
    source_groups      = [nsxt_policy_group.uag_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_pcoip.path]
  ...
  rule {
    display_name       = "TF - UAG - UAG to Horizon Agent via RDP"
    source_groups      = [nsxt_policy_group.uag_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_rdp.path]
  ...
  rule {
    display_name       = "TF - UAG - UAG to Horizon Agent Client Device Redirection"
    source_groups      = [nsxt_policy_group.uag_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_cdr.path]
  ...
  rule {
    display_name       = "TF - UAG - UAG to Horizon Agent USB Redirection"
    source_groups      = [nsxt_policy_group.uag_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_usb.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Domain AD Services"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Domain RPC"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.ad_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Domain RPC (Dynamic)"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.ad_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Domain SMB"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.ad_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Domain KERBEROS"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.ad_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Domain NetBIOS"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.ad_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to MSSQL DB"
    source_groups      = [nsxt_policy_group.connection_servers.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to vCenter Server"
    source_groups      = [nsxt_policy_group.connection_servers.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Horizon Agent via BLAST Extreme"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_blast_22443.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Horizon Agent via PCoIP"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_pcoip.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Horizon Agent via RDP"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_rdp.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Horizon Agent Client Device Redirection"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_cdr.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to Horizon Agent USB Device Redirection"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.desktop_pool.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_usb.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - JMS CS to CS Legacy"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - JMS CS to CS SSL"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to CS Replica Install"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to CS MS-RPC"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_alg_ms_rpc.path]
  ...
  rule {
    display_name       = "TF - Horizon CS - CS to CS MS-RPC DYNAMIC"
    source_groups      = [nsxt_policy_group.connection_servers.path]
    destination_groups = [nsxt_policy_group.connection_servers.path]
    action             = "ALLOW"
    services           = [nsxt_policy_service.service_hzn_alg_ms_rpc_dynamic.path]
  ...
  rule {
    display_name       = "TF - Horizon Desktop Pool - Pool to CS - JMS"
  ...
  rule {
    display_name = "TF - Horizon - Explicit Deny"
    action       = "REJECT"
    logged       = true
    direction    = "IN_OUT"
